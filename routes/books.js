...
router.get('/:id', async (req, res) => {
    try {
        // We need to "populate" the variable "author" inside the object "Book"
        // If we didn't populate, the "author" would have been an ID instead of an object
...
// Edit Book Route (for displaying the Form)
